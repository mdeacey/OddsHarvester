...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("football", "england-premier-league", "20-2024", "Invalid season format: 20-2024. Expected format: 'YYYY' or 'YYYY-YYYY'"),
        ("football", "england-premier-league", "202A-2024", "Invalid season format: 202A-2024. Expected format: 'YYYY' or 'YYYY-YYYY'"),
        ("football", "england-premier-league", "2023/2024", "Invalid season format: 2023/2024. Expected format: 'YYYY' or 'YYYY-YYYY'"),
        # Special cases that are invalid according to implementation
        ("football", "england-premier-league", "current", "Invalid season format: current. Expected format: 'YYYY' or 'YYYY-YYYY'"),
        ("football", "england-premier-league", " 2023-2024 ", "Invalid season format:  2023-2024 . Expected format: 'YYYY' or 'YYYY-YYYY'"),
        ("football", "england-premier-league", "Season_2023-2024", "Invalid season format: Season_2023-2024. Expected format: 'YYYY' or 'YYYY-YYYY'"),
    ]
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("football", "england-premier-league", "2023-2025", "Invalid season range: 2023-2025. The second year must be exactly one year after the first."),
        ("football", "england-premier-league", "2024-2023", "Invalid season range: 2024-2023. The second year must be exactly one year after the first."),
    ]
)
