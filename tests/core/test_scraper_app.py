...
from src.core.scraper_app import run_scraper, retry_scrape, TRANSIENT_ERRORS
...
async def test_retry_scrape_transient_error(mock_sleep):
    ...
    mock_func.side_effect = [
        Exception(f"Connection failed: {TRANSIENT_ERRORS[0]}"),
        {"data": "retry_success"}
    ]
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            {},
            "Both 'sport', 'league' and 'season' must be provided for historic scraping"
        ),
        (
