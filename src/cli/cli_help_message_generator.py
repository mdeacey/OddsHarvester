class CLIHelpMessageGenerator:
    def generate(self):
        return (
            ...
            "   --leagues                   ⚽ Specific leagues to target (comma-separated, e.g., england-premier-league,spain-primera-division). Overrides sport and date.\n"
            ...
            "   --sport                     🏆 The sport to scrape (default: football).\n"
            "   --leagues                   ⚽ The leagues to scrape (comma-separated, e.g., england-premier-league,spain-primera-division).\n"
            ...
            "   `python main.py scrape_upcoming --leagues england-premier-league,spain-primera-division --markets 1x2`\n\n"
            "✅ **Scrape historical odds for the Premier League (2022-2023 season):**\n"
            "   `python main.py scrape_historic --sport football --leagues england-premier-league --season 2022-2023 --markets 1x2 --storage remote --headless`\n\n"
            "✅ **Scrape historical odds for multiple leagues:**\n"
            "   `python main.py scrape_historic --sport football --leagues england-premier-league,spain-primera-division --season 2022-2023 --markets 1x2`\n\n"
            ...
            "💡 **Note:**\n"
            "- If both **date** and **leagues** are provided for `scrape_upcoming`, the scraper will ignore the date and scrape all upcoming matches for those leagues.\n"
